...
设置 `TOKEN_PATH` 变量，格式为：`路径@专用令牌`，多个路径用逗号分隔：
```
TOKEN_PATH="sh@123456,admin@abcdef,private@xyz789"
```
...
4. ➕ 添加以下变量：
   ...
   - 🎯 变量：TOKEN_PATH（可选），值：路径专用令牌配置（格式：`路径@令牌`）
...
### 📝 配置格式
```
TOKEN_PATH="路径1@令牌1,路径2@令牌2,路径3@令牌3"
```
